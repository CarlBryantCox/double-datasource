...
public class MarkMonitor {
    ...
    private static final String url1 = "http://jz.jtyedu.com/v1/smart/yuejuan-single-business/druid/weburi-/api/markingTask/getPaper.json";
    private static final String url2 = "http://jz.jtyedu.com/v1/smart/yuejuan-single-business/druid/weburi-/api/markingTask/submitScore.json";
    private static final String url3 = "http://jz.jtyedu.com/v1/smart/yuejuan-union-business/druid/weburi-/api/teacher/markingTask/getPaper.json";
    private static final String url4 = "http://jz.jtyedu.com/v1/smart/yuejuan-union-business/druid/weburi-/api/teacher/markingTask/submitScore.json";
    private static final String url5 = "http://jz.jtyedu.com/v1/smart/yuejuan-single-business/druid/webapp.json";
    private static final String url6 = "http://jz.jtyedu.com/v1/smart/yuejuan-union-business/druid/webapp.json";
    ...
    public void monitorSingleGetPaper(){
        ...
        try {
            this.getMarkingLog(requestEntity);
    ...
    private void getMarkingLog(HttpEntity<MultiValueMap<String, String>> requestEntity){
